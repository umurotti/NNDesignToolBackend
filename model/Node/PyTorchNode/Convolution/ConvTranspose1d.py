...
class ConvTranspose1d(PyTorchNode):
    ...
    def build_constructor(self) -> str:
        return f"self.{self.custom_name} = torch.nn.ConvTranspose1d({self.in_channels}, {self.out_channels}, {self.kernel_size}, {self.stride}, {self.padding}, {self.output_padding}, {self.groups}, {self.bias}, {self.dilation})"
