...
class MaxPool2d(PyTorchNode):
    ...
    def build_constructor(self) -> str:
        return f"self.{self.custom_name} = torch.nn.MaxPool2d({self.kernel_size}, {self.stride}, {self.padding}, {self.dilation}, {self.return_indices}, {self.ceil_mode})"
