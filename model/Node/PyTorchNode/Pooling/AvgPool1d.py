...
class AvgPool1d(PyTorchNode):
    ...
    def build_constructor(self) -> str:
        return f"self.{self.custom_name} = torch.nn.AvgPool1d({self.kernel_size}, {self.stride}, {self.padding}, {self.ceil_mode}, {self.count_include_pad})"
